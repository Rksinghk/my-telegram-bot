...
async def start(message: types.Message):
    ...
    await message.answer_photo(photo="https://i.postimg.cc/02GRzWDB/file-00000000d74071fa86d1d103d4ac7342.png", 
                               caption=caption, reply_markup=start_kb(message.from_user.id))
